...
function DeleteDialog(props) {
	...
	if (props.todo.estudiante_id) {
		...
		update = {
			...
			estado: estado,
			elemento_id: [],
			fecha_solicitud: props.todo.fecha_solicitud,
			hora_solicitud: props.todo.hora_solicitud,
		...
		update = {
			...
			mantenimiento_id: props.todo.mantenimiento_id,
					...
					onClick={() => {
						...
						if (update.estudiante_id) {
							...
							if (props.entregar === true ) {
								context.updateMantenimientoEle(Object.assign(update, { entregar: 'si' }));
							}else{
								context.updateMantenimientoEle(Object.assign(update, { entregar: 'no' }));
							}
						}
						hide();
					}}
